...
export const goldenLonger = (input) => input * ((1 + Math.sqrt(5)) / 2);
export const goldenShorter = (input) => input / ((1 + Math.sqrt(5)) / 2);

export default function GoldenDetails({ input }) {
  return (
    <div className="flex justify-center pt-3">
      <svg width="327" height="142" viewBox="0 0 327 142" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <text
          ...
          x="302"
          y="25"
          textAnchor="middle">{goldenShorter(goldenShorter(input)).toFixed(3)}
        </text>
        <path
        ...
        <text
          ...
          x="239"
          y="137"
          textAnchor="middle">{goldenShorter(input).toFixed(3)}</text>
        <path
          className="stroke-green-400"
        ...
        <text
          ...
          x="125"
          y="137"
          textAnchor="middle">{goldenLonger(input).toFixed(3)}</text>
        <path
          className="stroke-green-400"
