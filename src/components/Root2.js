...
export const root2Longer = (input) => input * 1.41;
export const root2Shorter = (input) => input / 1.41;

export default function Root2Details({ input }) {
  return (
    <div className="flex justify-center pt-4">
      <svg width="293"
        ...
        <text
          ...
          x="270"
          y="26"
          textAnchor="middle">{root2Shorter(root2Shorter(input)).toFixed(3)}
        </text>
        <text
          className="fill-green-400 text-sm font-bold"
          x="207"
          y="142"
          textAnchor="middle">{root2Shorter(input).toFixed(3)}
        </text>
        <text
        ...
        <text
          ...
          x="110"
          y="142"
          textAnchor="middle">{root2Longer(input).toFixed(3)}
        </text>
      </svg>
    </div>
  )
