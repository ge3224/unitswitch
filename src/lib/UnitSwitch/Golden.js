      ...
      <div className="flex justify-center pt-4">
        ...
        >
          <rect
            ...
            width="141.613"
            height="85.9871"
            className="fill-green-usw-300 stroke-green-usw-600"
          />
          <path
            d="M52.0223 2.69029L192.841 88.7806"
            className="stroke-green-usw-600"
            strokeDasharray="2 2"
          />
          <path
          ...
          <path
            className="stroke-green-usw-400"
          ...
          />
          <text
            className="fill-green-usw-600 font-space font-bold text-sm "
            x="16"
            y="44"
          ...
          <text
            className="fill-green-usw-400 font-space font-bold text-sm"
            x="125"
            y="140"
