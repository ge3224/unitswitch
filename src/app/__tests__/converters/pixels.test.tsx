...
describe('toPixels', () => {
  ...
  it('should convert Points to pixels correctly', () => {
    expect(toPixels.convert(Unit.Points, 1)).toBeCloseTo(Math.ceil(1.3333343412075));
